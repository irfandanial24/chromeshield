# 🛡️ ChromeShield — Malicious Browser Extension Detection System

ChromeShield is a **rule-based static analysis** tool that detects malicious
...
code. ChromeShield helps a user (or a reviewer) decide whether an extension is
...
```
ChromeShield/
├── chromeshield/            # the analysis engine (pure standard library)
