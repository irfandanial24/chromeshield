# cli.py
# Command-line version of ChromeShield.
...
from chromeshield.report import format_text


def main(argv=None):
    parser = argparse.ArgumentParser(
        description="ChromeShield - detect malicious Chrome extensions (static analysis)."
    )
